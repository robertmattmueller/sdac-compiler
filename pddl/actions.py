...
class Action(object):
    ...
    def instantiate(self, var_mapping, init_facts, fluent_facts,
        ...
        if effects:
            if isinstance(self.cost, pddl_parser.CostNode):
                    #cost = self.cost.instantiate(var_mapping, objects_by_type)
                    result = []
                    cost = self.cost.instantiate(var_mapping, init_facts, fluent_facts,
