...
def translate_task(strips_to_sas, ranges, translation_key,
                   ...
                   init, goals,
                   actions, axioms, metric, implied_facts, atom_groups):
    ...
    variables = sas_tasks.SASVariables(ranges, axiom_layers, translation_key, atom_groups)    
    #for var, rang in enumerate(variables.ranges):
     #   print("v%d in {%s}" % (var, list(range(rang))))
